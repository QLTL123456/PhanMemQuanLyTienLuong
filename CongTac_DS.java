...
public class CongTac_DS {
    ...
    public static void themCongTac(String maCT, String maNV, String tgbd, String tgkt, String ct)
    {
        String sql="INSERT INTO dbo.QUATRINHCONGTAC (MAQTCT, MANV, TGBATDAU, TGKETTHUC, TENCONGTY) values (?, ?, ?, ?, ?)";
        try {
    ...
    public static void suaCongTac(String maCT, String maNV, String tgbd, String tgkt, String ct)
    {
        String sql = "UPDATE dbo.QUATRINHCONGTAC SET MANV='"+maNV+"', TGBATDAU='"+tgbd+"', TGKETTHUC='"+tgkt+"', TENCONGTY='"+ct+"' where MAQTCT='"+maCT+"'";
        try {
            pst=conn.prepareStatement(sql);
            pst.execute();
